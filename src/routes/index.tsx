    ...
    <div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12">
        <div className="flex items-end justify-between">
          ...
          <Button asChild variant="ghost" className="gap-1 rounded-xl">
            <Link to="/shop">
          ...
          {categories.map((c) => {
            ...
            return (
              <Link
                ...
                className="surface-card hover-lift group flex flex-col items-start p-5"
              >
                <div className="grid size-12 place-items-center rounded-2xl bg-secondary/10 text-secondary transition-colors group-hover:bg-secondary group-hover:text-secondary-foreground">
